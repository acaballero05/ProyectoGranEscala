...
echo '<script languaje=javascript>
              jAlert("Se ha agregado la reserva correctamente", "Mensaje",function(){ window.location="reserva.php";});
              </script>';
 }
 else{
 	echo '<script languaje=javascript>
              jAlert("Ya existe una reserva en ese horario.", "Mensaje",function(){ window.location="reserva.php";});
              </script>';
 }
// Cerrar la conexión
mysqli_close($mysqli);
